PRINT Db_Name()+', Criação da Procedure USPPhanchaListar'

GO
--------------------------------------------------------------------------------------
-- OBJETO: USPPhanchaListar – RESPONSÁVEL: Anderson – DATA: 10/10/2018 – 
--------------------------------------------------------------------------------------
IF EXISTS( SELECT
               NAME
           FROM
           ...
           WHERE
             XTYPE = 'P'
             AND NAME = 'USPPhanchaListar' )
    DROP PROCEDURE USPPhanchaListar

GO

CREATE PROCEDURE USPPhanchaListar
