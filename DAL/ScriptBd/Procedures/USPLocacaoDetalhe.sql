PRINT Db_Name()+', Criação da Procedure USPLocacaoDetalhe'

GO
--------------------------------------------------------------------------------------
-- OBJETO: USPLocacaoDetalhe – RESPONSÁVEL: Anderson – DATA: 10/10/2018 – 
--------------------------------------------------------------------------------------
IF EXISTS( SELECT
               NAME
           FROM
           ...
           WHERE
             XTYPE = 'P'
             AND NAME = 'USPLocacaoDetalhe' )
    DROP PROCEDURE USPLocacaoDetalhe

GO

CREATE PROCEDURE USPLocacaoDetalhe
		   @IDLOCACAO int
AS
    SET NOCOUNT ON
...
WHERE TB_LOCACAO.IDLOCACAO = @IDLOCACAO