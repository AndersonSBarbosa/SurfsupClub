PRINT Db_Name()+', Criação da Procedure USPPranchaListarPranchasAtivasSite'

GO
--------------------------------------------------------------------------------------
-- OBJETO: USPPranchaListarPranchasAtivasSite – RESPONSÁVEL: Anderson – DATA: 10/10/2018 – 
--------------------------------------------------------------------------------------
IF EXISTS( SELECT
               NAME
           FROM
           ...
           WHERE
             XTYPE = 'P'
             AND NAME = 'USPPranchaListarPranchasAtivasSite' )
    DROP PROCEDURE USPPranchaListarPranchasAtivasSite

GO

CREATE PROCEDURE USPPranchaListarPranchasAtivasSite
...
WHERE TB_PRANCHA.IDSTATUS = 1 AND TB_PRANCHA.IDTIPOITEM = 1