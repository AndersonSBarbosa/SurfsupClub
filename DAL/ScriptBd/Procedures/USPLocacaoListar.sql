PRINT Db_Name()+', Criação da Procedure USPlocacaoListar'

GO
--------------------------------------------------------------------------------------
-- OBJETO: USPlocacaoListar – RESPONSÁVEL: Anderson – DATA: 10/10/2018 – 
--------------------------------------------------------------------------------------
IF EXISTS( SELECT
               NAME
           FROM
           ...
           WHERE
             XTYPE = 'P'
             AND NAME = 'USPlocacaoListar' )
    DROP PROCEDURE USPlocacaoListar

GO

CREATE PROCEDURE USPlocacaoListar
