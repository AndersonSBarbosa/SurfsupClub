PRINT Db_Name()+', Criação da Procedure USPClienteListar'

GO
--------------------------------------------------------------------------------------
-- OBJETO: USPClienteListar – RESPONSÁVEL: Anderson – DATA: 10/10/2018 – 
--------------------------------------------------------------------------------------
IF EXISTS( SELECT
               NAME
           FROM
           ...
           WHERE
             XTYPE = 'P'
             AND NAME = 'USPClienteListar' )
    DROP PROCEDURE USPClienteListar

GO

CREATE PROCEDURE USPClienteListar
